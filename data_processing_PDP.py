...
for i in range(len(Cell_list)):
    if(1==Cell_list[i][2]['succeed_fail']):
        PDP_list.append(Cell_list[i][2]['original_PDP'])       #M=1
    if(1==Cell_list[i][0]['succeed_fail']):
        PDP_list.append(Cell_list[i][0]['original_PDP']/2)     #M=2 
    if(1==Cell_list[i][1]['succeed_fail']):
        PDP_list.append(Cell_list[i][1]['original_PDP']/2)     #M=2
    if(1==Cell_list[i][3]['succeed_fail']): 
        PDP_list.append(Cell_list[i][3]['original_PDP'])       #M=1
    if(1==Cell_list[i][5]['succeed_fail']):
        PDP_list.append(Cell_list[i][5]['original_PDP']/4)     #M=4
    if(1==Cell_list[i][4]['succeed_fail']):
        PDP_list.append(Cell_list[i][4]['original_PDP']/3)     #M=3
#PDP_list=list(set(PDP_list))
max_PDP=max(PDP_list)
min_PDP=min(PDP_list)
print(len(PDP_list))
print(max_PDP)
print(min_PDP)
...
for i in range(len(Cell_list)):
    if(1==Cell_list[i][2]['succeed_fail']):
        ...
        INV_file[17]='        y=torch.tensor(['+str((Cell_list[i][2]['original_PDP']-min_PDP)/PDP_range)+'])'+'\n'
        ...
        f.close()
        #PDP_list.append(Cell_list[i][2]['original_PDP'])
    if(1==Cell_list[i][0]['succeed_fail']):        
        ...
        AND2_file[22]='        y=torch.tensor(['+str((Cell_list[i][0]['original_PDP']-min_PDP)/(PDP_range*2))+'])'+'\n'
        ...
        f.close()
        #PDP_list.append(Cell_list[i][0]['original_PDP'])
    if(1==Cell_list[i][1]['succeed_fail']):     
        ...
        BUF_file[19]='        y=torch.tensor(['+str((Cell_list[i][1]['original_PDP']-min_PDP)/(PDP_range*2))+'])'+'\n'
        ...
        f.close()
        #PDP_list.append(Cell_list[i][1]['original_PDP'])
    if(1==Cell_list[i][3]['succeed_fail']):  
        ...
        NAND2_file[20]='        y=torch.tensor(['+str((Cell_list[i][3]['original_PDP']-min_PDP)/PDP_range)+'])'+'\n'
        ...
        f.close()
        #PDP_list.append(Cell_list[i][3]['original_PDP'])
    if(1==Cell_list[i][5]['succeed_fail']):
        ...
        XOR_file[28]='        y=torch.tensor(['+str((Cell_list[i][5]['original_PDP']-min_PDP)/(PDP_range*4))+'])'+'\n'
        ...
        f.close()
        #PDP_list.append(Cell_list[i][5]['original_PDP'])
    if(1==Cell_list[i][4]['succeed_fail']):
        ...
        OR_file[22]='        y=torch.tensor(['+str((Cell_list[i][4]['original_PDP']-min_PDP)/(PDP_range*3))+'])'+'\n'
        ...
        f.close()
        #PDP_list.append(Cell_list[i][4]['original_PDP'])
